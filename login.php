        ...
        <div class="overlay">
            <div class="content_login">
                <div class="form_login">
                    ...
                    <!-- FORMULÁRIO DE LOGIN -->
                    <form action="index.php?page=cad_produtos">
                        ...
                        <input type="password" class="form-control" id="id_senha" placeholder="SENHA" maxlength="8" required style="height: 45px; box-shadow: 0px 2px 6px #cccccc; margin-bottom: 10px;">
